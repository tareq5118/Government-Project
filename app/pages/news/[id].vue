...
<template>
  ...
  <div class=" md:py-4 py-10 mb-8" dir="rtl">
    <!-- <NuxtLink
      to="/news"
      class="inline-flex items-center gap-2 mb-4  mx-4 md:mb-2 text-lg font-medium"
    >
      العودة إلى الأخبار
      <span class="text-xl">←</span>
    </NuxtLink> -->
    <ButtonUI link="/" class="text-lg"> العودة إلى الأخبار </ButtonUI>
    ...
    <article v-if="newsItem" class="rounded-2xl px-6 overflow-hidden">
      <div class=" ">
        ...
        <h1
          class="text-2xl md:text-3xl lg:text-3xl font-bold mb-5 leading-tight"
        >
          {{ newsItem.title }}
        </h1>
      </div>
      <div class="w-full  mb-5 md:mb-2">
        <img
          v-if="newsItem.image"
          :src="newsItem.image"
          :alt="newsItem.title"
          height="900"
          width="1600"
          class="md:w-[80%] md:mx-auto rounded-2xl object-cover"
          loading="lazy"
        />
      </div>
