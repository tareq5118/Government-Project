...
<template>
  <header
    class="bg-Primary md:bg-white md:bg-[url(/images/star.png)] transition-all ease-linear duration-200"
  ...
  >
    <AppContainer>
      <div class="flex justify-between items-center">
        ...
        <div class="flex justify-between items-center">
          <div
            class="w-full border hidden md:border-border border-white rounded-lg sm:rounded-xl py-2 px-2 md:flex justify-around items-center"
          >
            <input
              type="search"
              placeholder="البحث"
          ...
          <button
            class="mx-4 hover:cursor-pointer text-sm sm:text-base md:block hidden"
          >
            English 
          </button>
        ...
        <div class="text-sm sm:text-base hover:cursor-pointer hidden">
          icons
        </div>
      </div>
    </AppContainer>
